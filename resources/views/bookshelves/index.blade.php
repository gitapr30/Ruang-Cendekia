...
<tr>
    ...
    <td class="p-3 text-sm text-gray-700 whitespace-nowrap">{{ $bookshelf->category->name ?? 'Tidak ada kategori' }}</td>
                        ...
                        <td class="p-3 text-sm text-gray-700 whitespace-nowrap flex space-x-2">
                            <a href="{{ route('bookshelves.edit', $bookshelf->id) }}" class="inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-yellow-400 hover:bg-yellow-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-yellow-500 no-underline">
