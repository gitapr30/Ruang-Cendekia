...
<div class="p-4">
    {{-- Header section untuk daftar perubahan --}}
    ...
    {{-- Tabel untuk menampilkan daftar perubahan --}}
    <div class="mt-6">
        <div class="overflow-auto rounded-lg shadow block w-full">
            <table class="table-auto w-full">
                ...
                <tbody class="divide-y divide-gray-200">
                    {{-- Kondisi jika tidak ada data perubahan --}}
                    @if ($changes->isEmpty())
                    <tr>
                    ...
                    {{-- Loop untuk menampilkan setiap data perubahan --}}
                    ...
                    <tr>
                        ...
                        <td class="p-3 text-sm text-gray-700 whitespace-nowrap flex space-x-2">
                            {{-- Tombol untuk melihat detail perubahan --}}
                            ...
                            {{-- Tombol untuk mengedit perubahan --}}
