    ...
    <div class="bg-white p-6 rounded-lg shadow-md">
        <div class="grid grid-cols-2 gap-4">
            <div>
                ...
                <p class="text-gray-600"><strong>Nama Website:</strong> {{ $change->nama_website }}</p>
                <p class="text-gray-600"><strong>Alamat:</strong> {{ $change->alamat }}</p>
                <p class="text-gray-600"><strong>No. Telepon:</strong> {{ $change->no_telp }}</p>
                <p class="text-gray-600"><strong>Email:</strong> {{ $change->email }}</p>
                <p class="text-gray-600"><strong>Maps:</strong> <a href="{{ $change->maps }}" target="_blank" class="text-blue-500 underline">Lihat Lokasi</a></p>
            </div>

            <div>
                <h2 class="text-lg font-semibold text-gray-700">Detail Tambahan</h2>
                <p class="text-gray-600"><strong>Judul:</strong> {{ $change->tittle }}</p>
                <p class="text-gray-600"><strong>Deskripsi:</strong> {{ $change->description }}</p>
                <p class="text-gray-600"><strong>Konten:</strong> {!! nl2br(e($change->content)) !!}</p>
                <p class="text-gray-600"><strong>Footer:</strong> {{ $change->footer }}</p>
            </div>
        </div>
