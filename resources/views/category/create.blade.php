...
@section('contentAdmin')
    {{-- Form untuk menambahkan kategori baru (untuk admin) --}}
                ...
                <div class="grid grid-cols-1 gap-4">
                    ...
                    <div>
                        ...
                        <input type="text" name="name" id="name"
                            ...
                            @else
                                dark:border-gray-300 {{-- Border abu-abu jika tidak ada error --}}
                            @endif
...
@section('contentPustakawan')
    {{-- Form untuk menambahkan kategori baru (untuk pustakawan) --}}
    {{-- Struktur sama dengan contentAdmin --}}
    <form action="{{ route('category.store') }}" method="POST" class="p-4" enctype="multipart/form-data">
        @csrf
        <div class="bg-white rounded-xl overflow-hidden">
            <div class="p-3 bg-blue-500">
