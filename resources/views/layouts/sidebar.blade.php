...
<div id="sidebar"
        ...
        <ul class="list-none list-inside px-5 mb-3">
                ...
                <a href="{{ route('borrow.laporan') }}"
                    ...
                    @if (Request::is('laporan*'))
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                            class="w-6 h-6 fill-white">
                            <path
                                d="M19.5 21a3 3 0lapo 003-3v-4.5a3 3 0 00-3-3h-15a3 3 0 00-3 3V18a3 3 0 003 3h15zM1.5 10.146V6a3 3 0 013-3h5.379a2.25 2.25 0 011.59.659l2.122 2.121c.14.141.331.22.53.22H19.5a3 3 0 013 3v1.146A4.483 4.483 0 0019.5 9h-15a4.483 4.483 0 00-3 1.146z" />
                        </svg>
                    @else
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                            stroke="currentColor" class="w-6 h-6 text-white ">
            ...
            <li>
                <a href="{{ route('change.index') }}"
                    ...
                    @endif
                    <p class="ml-2 font-medium {{ Request::is('change*') ? 'text-white' : 'text-white' }} ">ubah
                    </p>
                </a>
            </li>
        </ul>
    ...
    @can('isPustakawan')
        ...
        <ul class="list-none list-inside px-5 mb-3">
            ...
            <li>
                <a href="{{ route('user.index') }}"
                    class="transition-all ease-in-out duration-300 flex items-center p-3 rounded-lg mb-1 {{ Request::is('user*') ? 'shadow-lg shadow-blue-200 rounded-lg bg-gradient-to-br from-blue-400 to-blue-500' : '' }}">
                    @if (Request::is('user*'))
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                            class="w-6 h-6 fill-white">
                            <path fill-rule="evenodd"
                    ...
                    @endif
                    <p class="ml-2 font-medium text-gray-700  {{ Request::is('user*') ? 'text-white' : 'text-gray-700' }} ">
                        pengguna</p>
                </a>
            </li>
            <li>
                <a href="{{ route('dashboard.index') }}"
                    class="transition-all ease-in-out duration-300 flex items-center p-3 rounded-lg mb-1 {{ Request::is('dashboard*') ? 'shadow-lg shadow-blue-200 rounded-lg bg-gradient-to-br from-blue-400 to-blue-500' : '' }}">
                    @if (Request::is('dashboard*'))
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                            class="w-6 h-6 fill-white">
                            <path fill-rule="evenodd"
            ...
            <li class="relative">
                <button
                    class="w-full flex items-center p-3 rounded-lg mb-1 transition-all ease-in-out duration-300 focus:outline-none"
