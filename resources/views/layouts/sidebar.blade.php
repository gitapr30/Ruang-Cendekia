        ...
        <p class="ml-2 font-medium text-white">Buku</p>
            ...
            <li class="relative">
                <button
                    ...
                    <img src="{{ asset('peminjaman.svg') }}" alt="Peminjaman" class="w-6 h-6 filter invert"> <!-- Added filter invert to make the icon white -->
                ...
                id="dropdownArrow" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="1.5">
                <path fill-rule="evenodd"
