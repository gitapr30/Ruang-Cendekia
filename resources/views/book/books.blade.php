            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-10">
                @foreach ($books as $book)
                    <a href="{{ route('books.show', $book->slug) }}"
                        class="group flex items-start space-x-4 transition rounded-md hover:scale-95 duration-300 relative">
                        @php
                            $dipinjam = false;
                        @endphp
                        ...
                        @if ($dipinjam == false)
                            ...
                            @endif
                        @endif
                        <img src="{{ asset( $book->image) }}" alt="books" class="w-40 h-60 object-cover rounded">
                        <div class="flex-1">
